...
public class CatalogoLogicaTest {
    ...
    public void setUp() {
        ...
        pendiente = new ProductoVO(TipoProducto.PULSERA, 200, null, TipoMaterial.ORO, distr, "anillo de oro");
        colgante = new ProductoVO(TipoProducto.PULSERA, 200, null, TipoMaterial.OROPLATA, distr, "pulsera de plata y oro");
    }
    ...
    public void testListadoFiltradoPorMaterial() {
        ...
        ProductoVO parametros = new ProductoVO(TipoProducto.PENDIENTE, -1.0, null, null, null, null);
    ...
    public void testListadoFiltradoPorPrecio() {
        prodDAO.create(pendiente);
        prodDAO.create(colgante);
        ProductoVO parametros = new ProductoVO(null, 120, null, null, null, null);
    ...
    public void testListadoFiltradoPorCIFProveedor() {
        ...
        ProductoVO parametros = new ProductoVO(null, -1.0, null, null, prov, null);
    ...
    public void testListadoFiltradoPorIdVenta() {
        ...
        ProductoVO parametros = new ProductoVO(null, -1.0, null, null, null, null);
    ...
    public void testListadoFiltradoCombinado() {
        ...
        ProductoVO parametros = new ProductoVO(TipoProducto.PULSERA, 200, null, null, prov, null);
